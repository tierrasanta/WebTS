...
namespace TierraSanta.Controllers
{
    ...
    public class ActividadesInsumoController : Controller
    {
        private EntitiesTierraSanta db = new EntitiesTierraSanta();

		
        // GET: ActividadesInsumo
		...
		//
            ...
            //{
            var pager = new Pager(db.TABLAS_ACTIVIDADES.Where(x => x.idactividad.StartsWith("05")).Count(), page);
            viewModel.Items = db.TABLAS_ACTIVIDADES.Where(x => x.idactividad.StartsWith("05")).Include(t => t.TABLAS_CULTIVOS)
        ...
        // GET: ActividadesInsumo/Details/5
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.idactividad = new SelectList(db.TABLAS_ACTIVIDADES.Where(x => x.idactividad.StartsWith("050") && x.idactividad.EndsWith("0000") && x.idactividad != "05000000"), "idactividad", "descripcion");
            return View();
        }

        // POST: ActividadesInsumo/Create
        ...
        {
            List<TABLAS_ACTIVIDADES> ta = db.TABLAS_ACTIVIDADES.Where(x => x.idactividad.StartsWith(tABLAS_ACTIVIDADES.idactividad.Substring(0, 4)) && x.idactividad.Substring(4, 7) != "0000" && x.idactividad != "05000000").ToList();
        ...
        // GET: ActividadesInsumo/Delete/5
        ...
        // POST: ActividadesInsumo/Delete/5
