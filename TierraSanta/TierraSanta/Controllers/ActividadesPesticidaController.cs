...
namespace TierraSanta.Controllers
{
	...
	public class PesticidaIndexViewModel
    {
    ...
    public class ActividadesPesticidaController : Controller
    {
        ...
        {
		//
			var viewModel = new PesticidaIndexViewModel();            

            //if (Search == null || Search.Equals(""))
            //{
				
                var pager = new Pager(db.TABLAS_ACTIVIDADES.Where(x => x.idactividad.StartsWith("04")).Count(), page);
                viewModel.Items = db.TABLAS_ACTIVIDADES.Where(x => x.idactividad.StartsWith("04")).Include(t => t.TABLAS_CULTIVOS)
    ...
    //        }
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.idactividad = new SelectList(db.TABLAS_ACTIVIDADES.Where(x => x.idactividad.StartsWith("040") && x.idactividad.EndsWith("0000") && x.idactividad != "04000000"), "idactividad", "descripcion");
            return View();
        }
        ...
        {
            List<TABLAS_ACTIVIDADES> ta = db.TABLAS_ACTIVIDADES.Where(x => x.idactividad.StartsWith(tABLAS_ACTIVIDADES.idactividad.Substring(0, 4)) && x.idactividad.Substring(4, 7) != "0000" && x.idactividad != "04000000").ToList();
