...
namespace WebTS2.Controllers
{
    ...
    public class ActividadesInsumosIndexViewModel
    {
        public List<TablaActividades> Items { get; set; }
        public Pager Pager { get; set; }
    }

    public class ActividadesInsumosController : Controller
    {
        private EntitiesTierraSanta db = new EntitiesTierraSanta();


        // GET: ActividadesInsumos
        public ActionResult Index(int? page, String Search)
        {
            ...
            {
                var pager = new Pager(db.TablaActividades.Where(x => x.idparent == 5 && x.abreviatura != "" && x.descripcion.Contains(Search)).Count(), page);
                viewModel.Items = db.TablaActividades.Where(x => x.idparent == 5 && x.abreviatura != "" && x.descripcion.Contains(Search)).Include(t => t.TablaCultivos).Include(t => t.TablaActividades2)
                    .OrderBy(c => c.idactividades)
                    .Skip((pager.CurrentPage - 1) * pager.PageSize)
                    .Take(pager.PageSize).ToList();
                viewModel.Pager = pager;
        ...
        // GET: ActividadesInsumos/Details/5
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.idparent = new SelectList(db.TablaActividades.Where(x => x.idparent == 5 && x.abreviatura == ""), "idparent", "descripcion");
            return View();
        }

        // POST: ActividadesInsumos/Create
        ...
        // POST: ActividadesInsumos/Edit/5
        // Para protegerse de ataques de publicación excesiva, habilite las propiedades específicas a las que desea enlazarse. Para obtener 
        // más información vea https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: ActividadesInsumos/Delete/5
        ...
        // POST: ActividadesInsumos/Delete/5
        ...
        public ActionResult ReportExcel()
        {
            using (var package = new ExcelPackage())
            {
                ...
                List<TablaActividades> list = db.TablaActividades.Where(x => x.idparent == 5).Include(t => t.TablaCultivos).Include(t => t.TablaActividades2).ToList();
                int pos = 4;
