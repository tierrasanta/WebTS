...
namespace WebTS2.Controllers
{
    ...
    public class ActividadesPesticidaIndexViewModel
    {
        public List<TablaActividades> Items { get; set; }
        public Pager Pager { get; set; }
    }

    public class ActividadesPesticidaController : Controller
    {
        private EntitiesTierraSanta db = new EntitiesTierraSanta();


        // GET: ActividadesPesticida
        public ActionResult Index(int? page, String Search)
        {
            //
            var viewModel = new ActividadesPesticidaIndexViewModel();


            if (Search == null || Search.Equals(""))
            {
                var pager = new Pager(db.TablaActividades.Where(x => x.idparent == 4 && x.abreviatura != "").Count(), page);
                viewModel.Items = db.TablaActividades.Where(x => x.idparent == 4 && x.abreviatura != "").Include(t => t.TablaCultivos).Include(t => t.TablaActividades2)
            ...
            {
                var pager = new Pager(db.TablaActividades.Where(x => x.idparent == 4 && x.abreviatura != "" && x.descripcion.Contains(Search)).Count(), page);
                viewModel.Items = db.TablaActividades.Where(x => x.idparent == 4 && x.abreviatura != "" && x.descripcion.Contains(Search)).Include(t => t.TablaCultivos).Include(t => t.TablaActividades2)
                    .OrderBy(c => c.idactividades)
                    .Skip((pager.CurrentPage - 1) * pager.PageSize)
                    .Take(pager.PageSize).ToList();
                viewModel.Pager = pager;
        ...
        // GET: ActividadesPesticida/Details/5
        ...
        // GET: ActividadesPesticida/Create
        public ActionResult Create()
        {
            ...
            ViewBag.idparent = new SelectList(db.TablaActividades.Where(x => x.idparent == 4 && x.abreviatura == ""), "idparent", "descripcion");
            return View();
        }

        // POST: ActividadesPesticida/Create
        ...
        // GET: ActividadesPesticida/Edit/5
        ...
        // POST: ActividadesPesticida/Edit/5
        // Para protegerse de ataques de publicación excesiva, habilite las propiedades específicas a las que desea enlazarse. Para obtener 
        // más información vea https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: ActividadesPesticida/Delete/5
        ...
        // POST: ActividadesPesticida/Delete/5
