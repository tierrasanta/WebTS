...
namespace WebTS2.Controllers
{
    ...
    public class ActividadesFertilizanteController : Controller
    {
        ...
        public ActionResult ReportExcel()
        {
            using (var package = new ExcelPackage())
            {
                ...
                foreach (var item in list)
                {
                    ...
                    ws.Cells[pos, 5].Value = item.unimedida == null ? "" : item.TablaCultivos.descripcion.ToString();
        ...
        public ActionResult ReportPDF()
        {
            ...
            //
            List<TablaActividades> list = db.TablaActividades.Where(x => x.idparent == 3).Include(t => t.TablaActividades2).ToList();
